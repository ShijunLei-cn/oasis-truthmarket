...
python ./example/run_rq1_experiment.py \
    ...
    --output-dir experiments/paper/rq1/r_wo \
...
python ./example/run_rq1_experiment.py \
    ...
    --output-dir experiments/paper/rq1/rw_wo \
    --probe-interval ${PROBE_INTERVAL} \
    --config "${CONFIG_FILE}"
...
python ./example/run_single_config_experiment.py \
    --experiment-id paper/rq3/r_wsc_F \
    --market-type reputation_only \
...
python ./example/run_single_config_experiment.py \
    --experiment-id paper/rq3/r_wsc_R \
    --market-type reputation_only \
    --communication seller \
...
python ./example/run_single_config_experiment.py \
    --experiment-id paper/rq3/rw_wsc_F \
    --market-type reputation_and_warrant \
    --communication seller \
    --communication-channel-type Fake \
    --runs 5 \
...
python ./example/run_single_config_experiment.py \
    --experiment-id paper/rq3/rw_wsc_R \
    --market-type reputation_and_warrant \
    --communication seller \
    --communication-channel-type Real \
    --runs 5 \
...
python ./example/run_single_config_experiment.py \
    --experiment-id paper/rq4/r_wbc_F \
    --market-type reputation_only \
    --communication buyer \
    --communication-channel-type Fake \
    --runs 5 \
...
python ./example/run_single_config_experiment.py \
    --experiment-id paper/rq4/r_wbc_R \
    --market-type reputation_only \
    --communication buyer \
    --communication-channel-type Real \
    --runs 5 \
...
python ./example/run_single_config_experiment.py \
    --experiment-id paper/rq4/rw_wbc_F \
    --market-type reputation_and_warrant \
    --communication buyer \
    --communication-channel-type Fake \
    --runs 5 \
...
python ./example/run_single_config_experiment.py \
    --experiment-id paper/rq4/rw_wbc_R \
    --market-type reputation_and_warrant \
    --communication buyer \
    --communication-channel-type Real \
    --runs 5 \
