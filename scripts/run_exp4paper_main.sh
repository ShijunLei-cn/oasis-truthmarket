...
python ./example/run_single_config_experiment.py \
    --experiment-id ${MODEL_TYPE}/paper_largescale/rq2/r_wsc_F \
    --market-type reputation_only \
...
python ./example/run_single_config_experiment.py \
    --experiment-id ${MODEL_TYPE}/paper_largescale/rq2/r_wsc_R \
    --market-type reputation_only \
    --communication seller \
...
python ./example/run_single_config_experiment.py \
    --experiment-id ${MODEL_TYPE}/paper_largescale/rq2/rw_wsc_F \
    --market-type reputation_and_warrant \
    --communication seller \
    --communication-channel-type Fake \
    --config "${CONFIG_FILE}"
...
python ./example/run_single_config_experiment.py \
    --experiment-id ${MODEL_TYPE}/paper_largescale/rq2/rw_wsc_R \
    --market-type reputation_and_warrant \
    --communication seller \
    --communication-channel-type Real \
    --config "${CONFIG_FILE}"
