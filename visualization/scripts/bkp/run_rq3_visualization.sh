...
R_F_EXP_ID="${R_F_EXP_ID:-r_wsc_F}"
R_R_EXP_ID="${R_R_EXP_ID:-r_wsc_R}"
RW_F_EXP_ID="${RW_F_EXP_ID:-rw_wsc_F}"
RW_R_EXP_ID="${RW_R_EXP_ID:-rw_wsc_R}"
...
# echo "=========================================="
# echo "RQ3 Communication Channel Visualization"
# echo "=========================================="
...
EXP_PREFIX="gpt-4o-mini/paper/rq3"
