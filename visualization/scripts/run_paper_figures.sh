...
export MPLCONFIGDIR="${MPLCONFIGDIR:-/tmp/oasis_mpl_cache}"
export NUMBA_CACHE_DIR="${NUMBA_CACHE_DIR:-/tmp/oasis_numba_cache}"
...
echo "  ${OUTPUT_BASE}/rq2/rq2_listed_vs_sold_counts.png"
echo "  ${OUTPUT_BASE}/rq2/rq2_product_quality_over_rounds.png"
echo "  ${OUTPUT_BASE}/rq2/rq2_warrant_micro_reasoning_impact.png"
echo "  ${OUTPUT_BASE}/rq2/rq2_rep_micro_reasoning_impact.png"
echo "  ${OUTPUT_BASE}/rq2/rq2_rep_micro_reasoning_impact_round_quality_topics.png"
echo "  ${OUTPUT_BASE}/rq2/rq2_rep_warrant_micro_reasoning_impact.png"
echo "  ${OUTPUT_BASE}/rq2/rq2_rep_warrant_micro_reasoning_impact_round_quality_topics.png"
echo "RQ3:"
...
echo "  ${OUTPUT_BASE}/rq3/rq3_all_constraints_grouped.png
  ${OUTPUT_BASE}/rq3/rq3_all_constraints_grouped_1x4.png"
echo "  ${OUTPUT_BASE}/rq3/rq3_warrant_micro_reasoning_impact.png"
echo "  ${OUTPUT_BASE}/rq3/rq3_rep_micro_reasoning_impact.png"
echo "  ${OUTPUT_BASE}/rq3/rq3_rep_micro_reasoning_impact_round_quality_topics.png"
echo "  ${OUTPUT_BASE}/rq3/rq3_rep_warrant_micro_reasoning_impact.png"
echo "  ${OUTPUT_BASE}/rq3/rq3_rep_warrant_micro_reasoning_impact_round_quality_topics.png"
echo "  ${OUTPUT_BASE}/rq3/rq3_bertopic_mechanisms.png"
echo "Tables:"
