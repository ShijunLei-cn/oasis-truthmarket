...
6. **`generate_paper_figures.py`**
   ...
   - Academic formatting with proper captions

7. **`test_table_generation.py`**
   - Test script to verify functionality
   - All tests pass ✓

8. **`README_PAPER_TABLES_EN.md`**
...
10. **`run_paper_visualization_main.sh`**
...
1. **Round Evolution Comparison** (`fig:round_evolution_comparison`)
   - Shows evolution of key market indicators across rounds
   - Compares Rep vs Rep+Warrant
   - 2x2 subplot layout with reputation, transactions, profit, utility
