...
├── README_PAPER_TABLES_EN.md          # Detailed documentation
├── SUMMARY_PAPER_TABLES_EN.md        # Implementation summary
└── USAGE_GUIDE_EN.md                 # This file
```
...
See `README_PAPER_TABLES_EN.md` for comprehensive documentation.
